            ...
            <div class="content" style="margin-top: 0px;">
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-md-12">
                           <div class="card">
                                <div class="card-header" data-background-color="orange" style="background-color: orange;">
                            ...
                            <div class="col-md-2 col-xs-2 text-center" style="width: 120px;">
                                <h1 style="font-weight: 800;border:3px solid #f28c32;border-radius: 100%;" id="days">4</h1>
                                <h4 style="margin-top:-7px;padding: 0px;font-weight: 400">Days</h4>
                            </div>:
                            <div class="col-md-2 col-xs-2" style="width: 120px;">
                                <h1 style="font-weight: 800;border:3px solid #f28c32;border-radius: 100%;" id="hours">4</h1>
                                <h4 style="margin-top:-7px;padding: 0px;font-weight: 400">Hours</h4>
                            </div>:
                            <div class="col-md-2 col-xs-2" style="width: 120px;">
                                <h1 style="font-weight: 800;border:3px solid #f28c32;border-radius: 100%;" id="minutes">4</h1>
                                <h4 style="margin-top:-7px;padding: 0px;font-weight: 400">Minutes</h4>
                            </div>
                            <div class="col-md-2 col-xs-2" style="width: 120px;">
                                <h1 style="font-weight: 800;border:3px solid #f28c32;border-radius: 100%;" id="seconds">4</h1>
                    ...
                    <div class="row">
                         ...
                         <?php 
                         $total_txns = $txn_between_date;
                         $target = $countdown->result()[0]->target;
                        
                         $percentage = $total_txns*100/$target;
                         ?>
                         <p style="text-align: center;"><?=$percentage?>% token of target <?=$target?> in current phase is sold </p>
                         <div class="progress">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats" style="min-height: 120px;">
                                 <div class="card-header" data-background-color="green">
                                   <!--<img src="<?=base_url()?>assets/img/Coinselfwhite.png" style="height: 55px;width: 55px;">-->
                                   <h3>YBT</h3>
                                </div>
                                <div class="card-content">
                                    <p class="category" style="font-size:20px;font-weight:500"><?=round(($_SESSION['etp_total_balance']/1000000000000000000),8)?></p>
                                    <h4 class="title">YBT Balance
                                    </h3>
                                </div>
                            </div>
                        </div>
