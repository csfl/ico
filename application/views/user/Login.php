...
<!--     <title>Naija Coin | Login Page</title>
 -->
            <title>YESBIT | Login Page</title>
    ...
    <nav class="navbar navbar-transparent navbar-absolute">
        <div class="container">
            ...
            <a class="navbar-brand" href="<?=base_url()?>"><img src="<?=base_url()?>assets/new/img/logo.png" alt="Logo"  data-placement="bottom" data-html="true" style="height: 70px;"></a>    
                ...
                <!-- <a class="navbar-brand" href="<?=base_url()?>"><img src="<?=base_url()?>nassets/img/BilkulNaya.png" alt="Logo"  data-placement="bottom" data-html="true" style="height: 70px;"></a> -->
                <!-- <h3>Naija Coin</h3> -->
            </div>
                        ...
                        <div class="card card-signup">
                            <form class="form" method="post" action="<?=base_url('user/login')?>">
                                ...
                                <div class="footer text-center">
                                    <input type="submit" class="btn btn-md" value="login" name="submit" style="background-color: black;" />
                                     <p class="help-block" style="color: #960004 "><?=form_error('password_confirmation','<div class="help-block" style="color: red ">', '</div>')?></p>
            ...
            <footer class="footer" style="margin-top: 140px;">
                <div class="container">
                    ...
                    <div class="copyright pull-right">
                        &copy; 2018, made with &nbsp;<i class="fa fa-heart heart" style="color:#f28c32;"></i>&nbsp; by <a href="https://www.cryptolaunch.in/">cryptolaunch.in</a>
                    </div>
                </div>
            </footer>
