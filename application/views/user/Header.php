...
<head>
    ...
    <style>
.card-header{
    background: #f28c32 !important;

}
.nav li.active a {
    background-color: #f28c32 !important;
}
</style>
</head>
    ...
    -->
            <div class="logo">
                <a href="<?=base_url('user/dashboard')?>" class="simple-text">
                    <img src="<?=base_url()?>assets/new/img/logo.png" alt="Logo"  title="" data-placement="bottom" data-html="true" style="height: 60px;">
                </a>
                <!-- <h3>Naija Coin</h3> -->
            </div>
            <div class="sidebar-wrapper" style="overflow: scroll;max-height: 600px;overflow-x: hidden;">
                <ul class="nav">
                    ...
                    <li class="<?php if($this->uri->segment(1) == 'Kyc'){ echo 'active';}?>">
                        <a href="<?=base_url();?>Kyc">
                            <p>KYC</p>
                        </a>
                        </li>
